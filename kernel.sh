...
fast_path=$GITHUB_WORKSPACE # This where kernelsource saved #only manual hook/kprobes hook, must be edited
...
#KSU DRIVER
curl -LSs "https://raw.githubusercontent.com/ReSukiSU/ReSukiSU/refs/heads/auto-hook/kernel/setup.sh" | bash -s auto-hook
